<template>
  <div class="container">
  	<div class="row">
        ...
        在一些场景中，你需要给同一个元素同时设置两种过渡动效，比如 animation 很快的被触发并完成了，而 transition 效果还没结束。
        在这种情况中，你就需要使用 type 特性并设置 animation 或 transition 来明确声明你需要 Vue 监听的类型。

        在我们的示例中，可以设置type进行查看，如果不设type或者设置为transition的，都会出现卡顿效果，而在设置为animation以后，
        就会变得顺畅
        -->
        ...
        否则 Vue为了效率只会替换相同标签内部的内容。即使在技术上没有必要，给在 <transition> 
